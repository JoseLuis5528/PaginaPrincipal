...
const experiences = [
    { role: "Técnico Ingenieria Industrial Sr", company: "Jabil Valdepeñas ", period: "2020 - 2025", desc: "Implementación de soluciones operativas y mejora continua en procesos industriales. Detección de oportunidades de mejora e implementación de sistemas de control. logros: reducir los arranques de linea,  implementando métodologias de Lean Six Sigma como sistemas controlados y configuraciones de torques, apoye manteniendo y cordinando los mantenimientos preventivos y correctivos tanto predictivos, dando el seguimiento de compra de herramentales, apoye en corridas NPI y mejora de procesos antes de entregar a producción, apoye en analisis de capacidad como en OEE y OLE ayudando a los supervisores a tener mejor arranque y organizacion de su gente " },
    { role: "Desarrollador De Ingenieria De Software", company: "Unadm-Freelance", period: "2022 - Actualidad -Ultimo Semestres", desc: "Desarrollo de aplicaciones web y soluciones tecnológicas para pequeños negocios. Implementación de sistemas de gestión y automatización de procesos. Actualmente se esta aprendiendo aplicaciones moviles, Desarrolle proyectos web de los cuales participe en instituciones secundaria como padre de la patria, actualmente me encuentro como Frelance apoyando en comunidades con problemas en diferentes entorno de programas." }
];
